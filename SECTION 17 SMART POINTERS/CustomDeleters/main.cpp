...
private:
    int data;
public:
    Test() : data{0} { std::cout << "\tTest constructor (" << this->data << ")" << std::endl; }
    Test(int data) : data {data} { std::cout << "\tTest constructor (" << this->data << ")" << std::endl; }

    int get_data() const { return this->data; }

    ~Test() { std::cout << "\tTest destructor (" << this->data << ")" << std::endl; }
};
